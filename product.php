...
$sql="INSERT INTO `product` (`discount`,`name`,`price`,`img`,`description`,`content`) 
...
<table class="table">
  ...
  {
      if($row['status']==1)
      $tatus=" <td><a href='index.php?cmd=product&action=lock&id=".$row['id']."' class='btn btn-success'><i class='fas fa-lock'></i></a></td>";
      else
      $tatus=" <td><a href='index.php?cmd=product&action=unlock&id=".$row['id']."' class='btn btn-default'><i class='fas fa-unlock'></i></a></td>";
      ...
      <td>".$row['price']."</td>
      <td>".$row['date']."</td>
      <td><a href='index.php?cmd=product&action=edit&id=".$row['id']."' class='btn btn-warning'><i class='fas fa-edit'></i></a></td>
      <td><a href='index.php?cmd=product&action=del&id=".$row['id']."' class='btn btn-danger'><i class='fas fa-trash'></i></a></td>
      ". $tatus ."
    </tr> ";
  }
  ?>
